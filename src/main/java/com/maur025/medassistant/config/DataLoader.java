...
public class DataLoader implements CommandLineRunner {
  ...
  public void run(String... args) {
    ...
    loadPatients();
    log.info(
      "Datos de prueba cargados: {} doctores, {} turnos, {} pacientes", doctorRepository.count(),
      appointmentRepository.count(), patientRepository.count()
    );
  }
  ...
  private void loadAppointments() {
    ...
    LocalTime[] times = {LocalTime.of(9, 0), LocalTime.of(10, 0), LocalTime.of(11, 0), LocalTime.of(
      15, 0)};
  ...
  private void loadPatients() {
    patientRepository.saveAll(List.of(
      Patient.builder()
        ...
        .conditions("Hipertensión leve controlada con medicación")
        .build(),
      ...
      Patient.builder()
        ...
        .conditions("Diabetes tipo 2 diagnosticada en 2019")
        .build(),
      ...
      Patient.builder()
        ...
        .conditions("Sin condiciones preexistentes")
        .build()
    ));
  }
}